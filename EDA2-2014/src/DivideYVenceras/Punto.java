...
public class Punto implements Comparable<Object> {		//Los puntos seran un objeto que usaremos para nuestro algoritmo, y contendrán los valores X e Y
	...
	public void setDiferencia(int dif){
		diferencia=dif;
	}
	...
	public int compareX(Object punto) {
	...
	public int compareTo(Object o) {
		if(this.diferencia>(((Punto) o).getDiferencia())){
			return 1;
		}else if(this.diferencia<(((Punto) o).getDiferencia())){
			return -1;
		}else if(this.diferencia==(((Punto) o).getDiferencia())){
			return this.compareX((Punto) o);
		}
		return 0;
	}
