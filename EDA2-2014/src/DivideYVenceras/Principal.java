...
public class Principal {
	...
	private static Punto seleccion(Punto punto) {
		...
		if(puntosLeidos.indexOf(punto)>0){
			for(int i=0;i<m;i++){
				if(puntosLeidos.indexOf(punto)-(i+1)==0){
					puntosAComprobar.add(puntosLeidos.get(puntosLeidos.indexOf(punto)-(i+1)));
					break;
				}
				puntosAComprobar.add(puntosLeidos.get(puntosLeidos.indexOf(punto)-(i+1)));
			}
		}
		if(puntosLeidos.indexOf(punto)<puntosLeidos.size()){
			for(int i=0;i<m;i++){
				if(puntosLeidos.indexOf(punto)+(i+1)==puntosLeidos.size()-1){
					puntosAComprobar.add(puntosLeidos.get(puntosLeidos.indexOf(punto)+(i+1)));
					break;
				}
				puntosAComprobar.add(puntosLeidos.get(puntosLeidos.indexOf(punto)+(i+1)));
